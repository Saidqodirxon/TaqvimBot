...
module.exports = {
  uz: {
    ...
    send_gps_location:
      "📍 GPS joylashuvingizni yuboring\n\n1️⃣ Pastdagi 📎 belgisini bosing\n2️⃣ Location → Send My Current Location\n3️⃣ Joylashuvingizni yuboring",
    location_send:
    ...
    greeting_sent_admin:
      "✅ Tabrigingiz qabul qilindi!\n\n📝 Admin ko'rib chiqgandan keyin kanalda e'lon qilinadi.\n⏳ Biroz sabr qiling.",
    greeting_approved:
  ...
  cr: {
    ...
    send_gps_location:
      "📍 GPS жойлашувингизни юборинг\n\n1️⃣ Пастдаги 📎 белгисини босинг\n2️⃣ Location → Send My Current Location\n3️⃣ Жойлашувингизни юборинг",
    ...
    greeting_sent_admin:
      "✅ Табригингиз қабул қилинди!\n\n📝 Админ кўриб чиққандан кейин каналда эълон қилинади.\n⏳ Бироз сабр қилинг.",
  ...
  ru: {
    ...
    greeting_sent_admin:
      "✅ Ваше поздравление принято!\n\n📝 После проверки администратором будет опубликовано в канале.\n⏳ Немного терпения.",
