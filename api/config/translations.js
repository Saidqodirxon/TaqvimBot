...
module.exports = {
  uz: {
    ...
    method_isna: "ISNA (Shimoli Amerika)",
    method_mwl: "MWL (Musulmon dunyosi ligasi)",
    method_makkah: "Umm al-Qura (Makka)",
    method_egypt: "Misr (Usul)",
    method_jafari: "Jafari (Shia)",
    method_tehran: "Tehran universiteti",
    method_gulf: "Fors ko'rfazi",
    method_kuwait: "Quvayt",
    method_qatar: "Qatar",
    method_singapore: "Singapur",
    method_france: "Frantsiya",
    method_turkey: "Turkiya",
    method_russia: "Rossiya",
  ...
  cr: {
    ...
    method_isna: "ИСНА (Шимолий Америка)",
    method_mwl: "МВЛ (Муслимон дунёси лигаси)",
    method_makkah: "Умм аль-Қура (Макка)",
    method_egypt: "Миср (Усул)",
    method_jafari: "Жафари (Шиа)",
    method_tehran: "Теҳрон университети",
    method_gulf: "Форс кўрфази",
    method_kuwait: "Қувайт",
    method_qatar: "Қатар",
    method_singapore: "Сингапур",
    method_france: "Франция",
    method_turkey: "Туркия",
    method_russia: "Россия",
    madhab_shafi: "Шофеий",
  ...
  ru: {
    ...
    method_mwl: "MWL (Мусульманская мировая лига)",
    method_makkah: "Умм аль-Кура (Мекка)",
    method_egypt: "Египет (Усуль)",
    method_jafari: "Джафари (Шииты)",
    method_tehran: "Тегеранский университет",
    method_gulf: "Персидский залив",
    method_kuwait: "Кувейт",
    method_qatar: "Катар",
    method_singapore: "Сингапур",
    method_france: "Франция",
    method_turkey: "Турция",
    method_russia: "Россия",
